...
while True:
    ...
    for face in faces2:
        landmarks_2 = predictor(img2_gray, face)
        landmarks_points_2 = []
        ...
        landmarks_points_2.remove((0,0))
        # cv2.circle(img2, (x, y), 3, (0, 255, 0), -1)
        points2 = np.array(landmarks_points_2, np.int32)
        convexhull2 = cv2.convexHull(points2)
    for i in landmarks_points_2:
        print(i)
    ...
    for triangle_index in indexes_triangles:
        ...
        ret, mask_triangles_designed = cv2.threshold(img2_new_face_rect_area_gray, 1, 255, cv2.THRESH_BINARY_INV)
